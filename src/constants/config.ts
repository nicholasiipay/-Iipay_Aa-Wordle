export const CONFIG = {
  ...
  language: 'Northern Kumeyaay', // This changes the display name for your language
  wordLength: 6, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Nicholas Smith', // Put your name here so people know who made this game!
  authorWebsite: 'YourLinkHere', // Put a link to your website or social media here
  wordListSource: 'Barona Inter Tribal Dictionary', // Describe the source material for your words here
